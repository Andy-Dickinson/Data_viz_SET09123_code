...
export default class Scatter extends Chart{
    ...
    _scat_click; _scat_mouseover; _scat_mouseout;
    _scat_ia_sel; _scat_ia_key;
    ...
    */
    updateEvents() {
        ...
        this.getInterSel().on('click', (event, datum) => {
                this._scat_click(datum[this.getInterKey()]); // changes clicked attribute
            })
            .on('mouseover', (event, datum) => {
                this._scat_mouseover(datum[this.getInterKey()]);
            })
            .on('mouseout', (event, datum) => {
                this._scat_mouseout(datum[this.getInterKey()]);
            })
    }
