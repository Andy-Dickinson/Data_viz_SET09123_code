...
export default class Scatter extends Chart{
    ...
    - group_titles: list of string group titles in order relating to the dataset
    ...
    */
    render(data, x_key, y_key, group_titles = [], {x_title, y_title, include_x_domain_zero, include_y_domain_zero, axis_pad, nice, x_ticksize, y_ticksize, label_shift, label_spacing, dot_size, colour_scale, colour_range} = {}) {
        ...
        this.drawDots(dot_size, group_titles);
    ...
    // Draw dots on the scatter chart
    drawDots(dot_size = 5, group_titles) {
