...
export default class LineChart extends Chart{
    ...
    - x_key: used to look up x-axis values, can be a string (if 1D data) or list of strings (for multiple lines)
    - y-key: used to look up y-axis values, can be a string (if 1D data) or list of strings (for multiple lines)
...
// add way to hide end ticks, probably as method in chart ----------------------------------------------------------------------------------------
        ...
        if (typeof(x_key) === "string") {
            ...
            this.x_key_list = x_key;
        }

        if (typeof(y_key) === "string") {
            this.y_key = `${y_key}`;
        }else{
            this.y_key_list = y_key;
        }
        ...
        if (this.sorted_dataset.every(d => !Array.isArray(d))) {
            ...
            console.log("sorted ds: ", this.sorted_dataset);
            console.log("curve: ", curveType);
            console.log("this.x_key ", this.x_key);
            console.log("this.y_key: ", this.y_key);
            console.log("this.scaleX: ", this.scaleX);
            console.log("this.scaleY: ", this.scaleY);
            console.log(this.sorted_dataset[0].y);
            console.log(this.scaleX(this.sorted_dataset['y'] == 2011));
            ...
            console.log("sorted ds: ", this.sorted_dataset[0]);
            console.log("curve: ", curveType);
            console.log("this.x_key ", this.x_key);
            console.log("this.y_key: ", this.y_key);
            console.log("this.scaleX: ", this.scaleX);
            console.log("this.scaleY: ", this.scaleY);
            console.log("this.sorted_dataset[0][0].y: ", this.sorted_dataset[0][0].y);
            console.log("this.scaleX(this.sorted_dataset[0]['y'] == 2011): ", this.scaleX(this.sorted_dataset[0]['y'] == 2011));
