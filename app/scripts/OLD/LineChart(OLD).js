...
export default class LineChart extends Chart{
    ...
    - lineGroups: list of group titles in order, relating to each dataset
    - curveType: a string defining curve used in line generator
    - (optional) x_zero / y_zero: when false, uses data to define axis min
    - (optional) axis_pad adjusts domains so datapoints are not at chart edges - [x_left, x_right, y_bott, y_top] all default 0 
    ...
    */
    render(data, x_key, y_key, lineGroups, curveType, x_title, y_title, x_zero, y_zero, nice, axis_pad, x_tickSize, y_tickSize, lineWidth=3) {
