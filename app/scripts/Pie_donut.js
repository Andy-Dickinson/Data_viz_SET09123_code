...
export default class Pie_donut extends Chart{
    ...
    */
    render(data, categoryKey, categoryCount, padAngle=0.02, inner_r_factor=0.2, outer_r_factor=1) {
        ...
        let arcGen = d3.arc()
                .innerRadius(this.chartWidth/2)//*inner_r_factor)
                .outerRadius(this.chartWidth/2+50);//outer_r_factor);
